...
<p align="center">
  <a href="https://github.com/houyuhang915-sudo/Codex-Skin-Manager/releases">下载安装包</a>
  ·
...
### 安装后只看到自定义主题，没有 15 套内置主题

`v1.7.2` 起，管理器启动时会检查主题库，并从 `~/.codex/codex-dream-skin-studio/themes` 自动补齐缺失或不完整的内置主题。若界面提示“内置主题资源不完整”，说明只复制了管理器应用或引擎目录也已缺失，请重新运行完整 DMG 中的“安装 Codex 皮肤管理器.app”。构建流程也会在生成 DMG 后挂载验包，确认 15 套主题都能安装后才产生发行文件。
